...
export const buttonStyles = tv({
  base: "group inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  variants: {
    variant: {
      default:
        "bg-primary text-primary-foreground [box-shadow:inset_0_2px_0_theme(colors.primary.foreground/20%),0_3px_6px_theme(colors.primary.DEFAULT/10%)] hover:bg-primary/90",
      destructive:
        "border border-primary bg-destructive text-destructive-foreground hover:bg-destructive/90",
      outline:
